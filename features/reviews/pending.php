...
$reviews_no = count($reviews);
?>

<div class="container">
    <div class="row">
        <div class="col-md-12 mt-4 pendingReviews">
            <h4 id="reviews_number">
                <?= ($reviews_no === 0) ? 'No pending reviews' : 'Pending reviews ('.$reviews_no.'):' ?>
                <input type="hidden" id="reviewsNumber" value="<?=$reviews_no?>">
            </h4>

            <ul class="list-group mt-3" id="pendingReviews">
